...
<section class="section-quemsomos" id="sectionQuemSomos">
    <div class="container text-center">
        ...
        <div class="row desc-frases mb-5">
            ...
            <div class="col-12 col-lg-4 mb-4 px-4">
                <p class="mb-3">
                    Por vezes algumas empresas chegavam até nós sem o material da marca para nos auxiliar no desenvolvimento. Como nossos projetos buscam personalizar a identidade da marca, começamos a integrar os serviços de branding e identidade visual nas entregas.
                </p>
                <p>
