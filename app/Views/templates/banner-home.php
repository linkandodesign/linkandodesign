<section class="section-inicio" id="sectionInicio">
    <video id="videoBG" poster="/img/capa-video.svg" autoplay muted loop>
        <source src="/video/pexels-engin-akyurt-6071388.mp4" type="video/mp4">
    </video>
    <div class="container container-inicio">
        <div class="row">
            <div class="col-12 text-center mt-lg-5">
                <div class="meio-inicio mx-auto">
                    <p class="cor-amarela text-lg-start mb-4">_________________</p>
                    <h1 class="m-0"><?= $title ?></h1>
                    <p class="cor-amarela text-lg-end m-0">_________________</p>
                </div>
                <div class="col-12 mt-5 text-center">
                    <a class="btn-banner" href="orcamento">Quero um orçamento</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div id="sliderHeader" class="keen-slider">
                    ...
                    <div class="keen-slider__slide number-slide3" style="min-width: 400px; max-width: 400px">
                    ...
                    <div class="keen-slider__slide number-slide9" style="min-width: 400px; max-width: 400px">
                        Interface e Experiência de Usuário
                    </div>
