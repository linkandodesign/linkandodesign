    ...
    <div class="footer" id="footer">
        <div class="container">
            ...
            <div class="row text-center mt-3 mx-lg-5">
                ...
                <div class="col-12 col-lg mt-4 p-0">
                    <p>
                        <a href="https://api.whatsapp.com/send?phone=5544991024165&text=Ol%C3%A1,%20vim%20pelo%20site,%20gostaria%20de%20um%20atendimento."
                            target="_blank">
...
<div class="whats">
    <a href="https://api.whatsapp.com/send?phone=5544991024165&text=Ol%C3%A1,%20vim%20pelo%20site,%20gostaria%20de%20um%20atendimento." target="_blank">
        <img class="img-fluid" src="/img/whats.png" alt="Whatsapp flutuante para contato com a Linkando Design.">
    </a>
</div>
